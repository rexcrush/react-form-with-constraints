...
var EventEmitter = /** @class */ (function () {
    ...
    EventEmitter.prototype.emit = function (eventName) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var listeners, ret, _a, listeners_1, listener, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        listeners = this.listeners.get(eventName);
                        ret = new Array();
                        if (!(listeners !== undefined)) return [3 /*break*/, 4];
                        console.assert(listeners.length > 0, "No listener for event '" + eventName + "'");
                        _a = 0, listeners_1 = listeners;
                        _d.label = 1;
                    case 1:
                        if (!(_a < listeners_1.length)) return [3 /*break*/, 4];
